...
1. Download the signature file (Download raw file):
   **[StaticConstructObject.lua](https://github.com/cheapmanga/FE-UE4SS-Mods/blob/main/UE4SS-installation/UE4SS_Signatures/StaticConstructObject.lua)**
...
**[UE4SS FE troubleshooting.md](https://github.com/cheapmanga/FE-UE4SS-Mods/blob/main/UE4SS-installation/Ue4ss%20fading%20echo%20troubleshooting.md)**

*(The "Solution A" will explain how to safely rename the folder and modify the Steam `appmanifest_2467880.acf` file while Steam is completely closed).*
